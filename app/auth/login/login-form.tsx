          ...
          <form onSubmit={handleSubmit} className="mx-auto flex w-full max-w-sm flex-col gap-5">
            ...
            <label className="block w-full text-center">
              ...
              <div className="relative">
                <input
                  className={`${dash.input} pe-11 text-center`}
                  name="password"
                ...
                <button
                  ...
                  className="absolute end-2 top-1/2 -translate-y-1/2 rounded-lg p-1.5 text-stone-400 transition hover:bg-stone-100 hover:text-stone-700"
                  aria-label={
