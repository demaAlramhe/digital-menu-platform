...
export function StoreIntroLocaleBar() {
  ...
  return (
    <div
      className="relative z-10 grid w-full grid-cols-3 gap-2"
      role="group"
      ...
      {LOCALE_ORDER.map((code) => {
        ...
        return (
          <button
            ...
            className={`w-full cursor-pointer rounded-full border px-2 py-2.5 text-center text-[11px] font-semibold leading-tight transition-all duration-200 disabled:opacity-50 sm:px-3 sm:text-xs ${
              isActive
